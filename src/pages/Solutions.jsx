    ...
    return (
        <div ref={containerRef} className="w-full bg-[#050508] min-h-screen pt-24 lg:pt-40 pb-24 lg:pb-40 overflow-x-hidden text-white font-sans">
            ...
            <div className="max-w-5xl mx-auto px-6 md:px-12 text-center mb-20 lg:mb-40 relative z-10 flex flex-col gap-8 items-center">
                ...
                <h1 className="font-serif italic text-3xl sm:text-4xl md:text-7xl lg:text-[7rem] leading-none mb-4 tracking-tighter flex flex-wrap justify-center gap-x-3 gap-y-2">
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12">
                ...
                <div className="mb-20 lg:mb-40 space-y-32">
                    ...
                    <div className="card-fall-container">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                            {/* Before */}
                            <div className="card-fall bg-[#0a0505] rounded-[2rem] sm:rounded-[3rem] p-6 sm:p-8 md:p-12 relative overflow-hidden group border border-red-500/10">
                                <div className="absolute top-4 right-4 sm:top-8 sm:right-8 text-red-500/30 font-serif italic text-3xl">Before</div>
                                <h3 className="font-sans font-black text-2xl sm:text-3xl mb-6 sm:mb-10 text-white/50 tracking-tighter">The Human Bottleneck</h3>
                            ...
                            {/* After */}
                            <div className="card-fall bg-[#050a08] rounded-[2rem] sm:rounded-[3rem] p-6 sm:p-8 md:p-12 relative overflow-hidden shadow-[0_0_60px_rgba(34,197,94,0.03)] border border-wa-green/10 transform transition-transform duration-700 hover:scale-[1.02] group">
                                ...
                                <div className="absolute top-4 right-4 sm:top-8 sm:right-8 text-wa-green font-serif italic text-3xl drop-shadow-[0_0_10px_rgba(37,211,102,0.8)]">After</div>
                                <h3 className="font-sans font-black text-2xl sm:text-3xl mb-6 sm:mb-10 tracking-tighter text-white">The Horizon System</h3>
                    ...
                    <div className="card-fall-container">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                            {/* Before */}
                            <div className="card-fall bg-[#0a0505] rounded-[2rem] sm:rounded-[3rem] p-6 sm:p-8 md:p-12 relative overflow-hidden group border border-red-500/10 min-h-0 lg:min-h-[450px]">
                                <div className="absolute top-4 right-4 sm:top-8 sm:right-8 text-red-500/30 font-serif italic text-3xl">Before</div>
                                <h3 className="font-sans font-black text-2xl sm:text-3xl mb-6 sm:mb-10 text-white/50 tracking-tighter">Manual Extraction</h3>
                                ...
                                <div className="absolute bottom-6 left-6 right-6 sm:bottom-8 sm:left-8 sm:right-8 md:bottom-12 md:left-12 md:right-12 pt-8 border-t border-red-900/20">
                                    <span className="block text-xs font-mono uppercase tracking-widest text-red-500/80 mb-2">Pain Points</span>
                            ...
                            {/* After */}
                            <div className="card-fall bg-[#05060a] rounded-[2rem] sm:rounded-[3rem] p-6 sm:p-8 md:p-12 relative overflow-hidden shadow-[0_0_60px_rgba(24,119,242,0.03)] border border-fb-blue/10 transform transition-transform duration-700 hover:scale-[1.02] group min-h-0 lg:min-h-[450px]">
                                ...
                                <div className="absolute top-4 right-4 sm:top-8 sm:right-8 text-fb-blue font-serif italic text-3xl drop-shadow-[0_0_10px_rgba(24,119,242,0.8)]">After</div>
                                <h3 className="font-sans font-black text-2xl sm:text-3xl mb-6 sm:mb-10 tracking-tighter text-white">The Horizon System</h3>
                                ...
                                <div className="absolute bottom-6 left-6 right-6 sm:bottom-8 sm:left-8 sm:right-8 md:bottom-12 md:left-12 md:right-12 pt-8 border-t border-fb-blue/20">
                ...
                <section className="mb-20 lg:mb-40 max-w-5xl mx-auto text-center border-t border-white/5 pt-32">
                    <h2 className="font-sans text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-black tracking-tighter mb-6 text-transparent bg-clip-text bg-gradient-to-br from-white to-white/40 pb-2">The AI Employee</h2>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
                        {/* 24/7 block */}
                        <div className="bg-[#050508] border border-white/5 flex flex-col items-center justify-center rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-8 md:p-10 hover:border-white/20 transition-all duration-500 group relative">
                        ...
                        {/* Speed block */}
                        <div className="bg-[#050508] border border-white/5 flex flex-col items-center justify-center rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-8 md:p-10 hover:border-amber-500/30 transition-all duration-500 group relative shadow-[0_0_0_transparent] hover:shadow-[0_0_40px_rgba(245,158,11,0.1)]">
                        ...
                        {/* Accuracy block */}
                        <div className="bg-[#050508] border border-white/5 flex flex-col items-center justify-center rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-8 md:p-10 hover:border-wa-green/30 transition-all duration-500 group relative shadow-[0_0_0_transparent] hover:shadow-[0_0_40px_rgba(37,211,102,0.1)]">
                        ...
                        {/* Scalable block */}
                        <div className="bg-[#050508] border border-white/5 flex flex-col items-center justify-center rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-8 md:p-10 hover:border-fb-blue/30 transition-all duration-500 group relative shadow-[0_0_0_transparent] hover:shadow-[0_0_40px_rgba(24,119,242,0.1)]">
                ...
                <div className="mb-20 lg:mb-40 pipeline-container relative z-10 bg-[#07070a] rounded-[2rem] sm:rounded-[3rem] p-6 sm:p-8 md:p-20 border border-white/5 overflow-hidden text-center shadow-xl">
                    ...
                    <h2 className="font-sans text-3xl sm:text-4xl md:text-5xl font-black tracking-tighter mb-6 text-white relative z-20">Pipeline Architecture</h2>
                ...
                <div className="mb-20 lg:mb-40 pt-20">
                    <h2 className="font-sans text-3xl sm:text-4xl md:text-5xl font-black tracking-tighter mb-12 md:mb-24 text-center text-white/50">Return On Investment</h2>

                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        <div className="text-center group border-r border-white/5 last:border-0 border-dashed">
                            <div className="text-3xl sm:text-4xl md:text-7xl lg:text-8xl font-black font-sans mb-6 text-transparent bg-clip-text bg-gradient-to-b from-white to-white/20 inline-block drop-shadow-xl">
