    ...
    return (
        <div ref={containerRef} className="w-full bg-[#0a0a0f] min-h-screen pt-24 lg:pt-40 pb-24 lg:pb-40 overflow-hidden font-sans text-white">
            ...
            <div className="max-w-5xl mx-auto px-6 md:px-12 text-center mb-20 lg:mb-40 relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-1000">
                ...
                <h1 className="font-serif italic text-3xl sm:text-4xl md:text-7xl lg:text-[7.5rem] leading-none mb-8 tracking-tighter drop-shadow-2xl">
            ...
            <div className="flex flex-col gap-12 lg:gap-24 w-full max-w-7xl mx-auto px-6 md:px-12 mb-20 lg:mb-40">
                {services.map((svc, index) => {
                    ...
                    return (
                        <div key={svc.id} className="feature-row-animate grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                            ...
                            {/* Text Block */}
                            <div className={`flex flex-col justify-center h-full min-h-0 lg:min-h-[350px] ${!isEven ? 'lg:order-2' : ''}`}>
                                ...
                                <h3 className={`font-sans text-3xl sm:text-4xl md:text-6xl font-black mb-6 tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-white ${colorMap[svc.colorKey].to}`}>
                                    {svc.title}
                                </h3>
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 mt-20">
                <div className="w-full bg-[#050508] border border-white/5 rounded-[3rem] p-8 md:p-20 text-center relative overflow-hidden flex flex-col items-center shadow-2xl">
                    <div className="absolute inset-0 bg-gradient-to-t from-fb-blue/5 to-transparent pointer-events-none"></div>
                    <h2 className="text-3xl sm:text-4xl md:text-6xl font-black tracking-tighter mb-6 drop-shadow-xl">Ready to upgrade your stack?</h2>
